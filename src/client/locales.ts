...
export const en = {
  ...
  filterOnlyEnabled: 'Enabled only',
  filterShowDeprecated: 'Show deprecated',
  filterHidden: 'hidden',
  sortLabel: 'Sort',
  sortDefault: 'New first',
...
export const zh: Record<keyof typeof en, string> = {
  ...
  filterOnlyEnabled: '仅显示已启用',
  filterShowDeprecated: '显示已弃用',
  filterHidden: '已隐藏',
  sortLabel: '排序',
  sortDefault: '新发布优先',
  sortReleased: '发布时间',
